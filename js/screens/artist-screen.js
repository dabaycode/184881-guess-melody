...
const backBtn = moduleElement.querySelector(`.game__back`);
backBtn.addEventListener(`click`, () => showScreen(welcomeScreen));

const resultSreens = [successScreen, failTimeScreen, failTriesScreen];

const artists = moduleElement.querySelectorAll(`.artist__name`);
artists.forEach((it) => it.addEventListener(`click`, () => showScreen(getRandomElement(resultSreens))));
